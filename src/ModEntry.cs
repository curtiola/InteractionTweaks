    ...
    public class ModEntry : Mod, IAssetEditor
    {
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            */
            ...
            Helper.ConsoleCommands.Add("carpenter_menu", "", (arg1, arg2) => Game1.activeClickableMenu = new StardewValley.Menus.CarpenterMenu(Game1.builder_robin));
        ...
        public bool CanEdit<T>(IAssetInfo asset)
        {
            ...
            return asset.Equals("Data/weapons");
        }

        public void Edit<T>(IAssetData asset)
        {
            if (asset.Equals("Data/weapons"))
            {
                //string[] dataArray = asset.AsDictionary<int, string>().Data[Slingshot.basicSlingshotId].Split('/');
                string[] dataArray = asset.AsDictionary<int, string>().Data[Slingshot.].Split('/');
                dataArray[1] = Helper.Translation.Get("item.slingshotdescr");
                asset.AsDictionary<int, string>().Data[Slingshot.basicSlingshotId] = string.Join("/", dataArray);

                dataArray = asset.AsDictionary<int, string>().Data[Slingshot.basicSlingshotId].Split('/');
                dataArray[1] = Helper.Translation.Get("item.slingshotdescr");
                asset.AsDictionary<int, string>().Data[Slingshot.basicSlingshotId] = string.Join("/", dataArray);
            }
        }
